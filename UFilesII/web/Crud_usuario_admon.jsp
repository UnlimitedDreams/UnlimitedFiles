    ...
    <div class="container">
        <div class="row">
            ...
            <center> 
                ...
                <a href="#modal1" class="btn btn-success"  data-toggle="modal" onclick="agrgar()">Agregar</a>
            </center>
            <script>
                function agrgar() {
                    $(document).ready(function() {
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                <center>
                                    <div id="crear_usu"></div>
                                </center>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-dismiss="modal">cerrar</button>
                            <button class="btn btn-primary" data-dismiss="modal">Agregar</button>
                        </div>
                    </div>
                </div>
            </div>
