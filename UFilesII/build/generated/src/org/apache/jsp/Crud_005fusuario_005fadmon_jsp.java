...
public final class Crud_005fusuario_005fadmon_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("                    ");
                        ...
                        for (int i = 0; i < Mis_usuarios.size(); i++) {
                            ...
                            //  out.println("<td> <a href=\"#modal1\"  class=\"btn btn-success\"   data-toggle=\"modal\" onclick=update(" + temp.getCedula() + ")>Update</a> </td>");
                            out.println("</tr>");
                        }
      ...
      out.write("\n");
      out.write("                </table>\n");
      out.write("                <a href=\"#modal1\" class=\"btn btn-success\"  data-toggle=\"modal\" onclick=\"agrgar()\">Agregar</a>\n");
      out.write("            </center>\n");
      out.write("            <script>\n");
      out.write("                function agrgar() {\n");
      out.write("                    $(document).ready(function() {\n");
      out.write("                        var option = 1;\n");
      out.write("                        $.post('Usuarios', {\n");
      out.write("                            opt: option,\n");
      out.write("                        }, function(responseText) {\n");
      out.write("                            $('#crear_usu').html(responseText);\n");
      out.write("                        });\n");
      out.write("\n");
      out.write("\n");
      out.write("                    });\n");
      ...
      out.write("                            <center><h1> CREAR USUARIO</h1></center> \n");
      out.write("                        </div>\n");
      out.write("                        <!-- contenido modal-->\n");
      out.write("                        <div class=\"modal-body\">\n");
      out.write("                            <form>\n");
      out.write("                                <center>\n");
      out.write("                                    <div id=\"crear_usu\"></div>\n");
      out.write("                                </center>\n");
      out.write("                            </form>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"modal-footer\">\n");
      out.write("                            <button class=\"btn btn-primary\" data-dismiss=\"modal\">cerrar</button>\n");
      out.write("                            <button class=\"btn btn-primary\" data-dismiss=\"modal\">Agregar</button>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
